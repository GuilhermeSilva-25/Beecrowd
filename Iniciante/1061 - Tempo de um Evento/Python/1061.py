...
def main():
    ...
    days, remainder = divmod(duration, SECONDS_IN_AN_DAY)
    hours, remainder = divmod(remainder, SECONDS_IN_AN_HOUR)
    minutes, seconds = divmod(remainder, SECONDS_IN_AN_MINUTE)
...
def get_time_in_seconds():
    ...
    total_seconds = (
        (day * SECONDS_IN_AN_DAY)
        + (hour * SECONDS_IN_AN_HOUR)
        + (minute * SECONDS_IN_AN_MINUTE)
        + second
    )
